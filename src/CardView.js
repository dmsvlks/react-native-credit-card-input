...
/* eslint react/prop-types: 0 */ export default class CardView extends Component {
  ...
  static defaultProps = {
    ...
    imageFront: cardImages.imageFrontDefault,
    imageBack: cardImages.imageBackDefault
  };
  ...
  render() {
    ...
    let { imageFront, imageBack } = this.props;

    if (brand === 'visa') {
      imageFront = cardImages.imageFrontVisa;
      imageBack = cardImages.imageBackVisa;
    } else if (brand === 'master-card') {
      imageFront = cardImages.imageFrontMastercard;
      imageBack = cardImages.imageBackMastercard;
    } else {
      imageFront = cardImages.imageFrontDefault;
      imageBack = cardImages.imageBackDefault;
    }
    ...
    const transform = { transform: [{ scale }, { translateY: (BASE_SIZE.height * (scale - 1)) / 2 }] };
